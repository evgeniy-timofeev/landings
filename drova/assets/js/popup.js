export default class Popup {
    ...
    init() {
        ...
        const existingShadow = document.querySelector('.popup__shadow');
        if (existingShadow) {
            this.shadow = existingShadow;
        } else {
            this.shadow = document.createElement('div');
            this.shadow.classList.add('popup__shadow');
    ...
    eventsFeeler() {
        ...
        if (this.config.closeOnOverlay) {
            document.addEventListener('mousedown', (e) => {
                if (!this._isMoved && (e.target instanceof Element) && !e.target.classList.contains('popup__wrap')) return;
                this._overlayChecker = true;
            });

            document.addEventListener('mouseup', (e) => {
                if (!this._isMoved && (e.target instanceof Element) && this._overlayChecker && e.target.classList.contains('popup__wrap')) {
                    e.preventDefault();
    ...
    open(selector) {
        ...
        this._modalBlock = this.openedWindow.querySelector('.popup__window');
        this.config.beforeOpen(this);
        this._bodyScrollControl();
        this.shadow.classList.add('popup__shadow--show');
        this.openedWindow.classList.add('popup--active');
    ...
    close() {
        ...
        if (this.config.waitTransitions) {
            this.openedWindow.classList.add('popup--moved');
            this._isMoved = true;
            this.openedWindow.addEventListener('transitionend', this._closeAfterTransition);
            this.openedWindow.classList.remove('popup--active');
        } else {
            this.openedWindow.classList.remove('popup--active');
    ...
    _closeAfterTransition() {
        this.openedWindow.classList.remove('popup--moved');
        this.openedWindow.removeEventListener('transitionend', this._closeAfterTransition);
        this._isMoved = false;
        this.shadow.classList.remove('popup__shadow--show');
    ...
    _bodyScrollControl() {
        ...
        if (this.isOpened === true) {
            html.classList.remove('popup__opened');
        ...
        html.classList.add('popup__opened');
    }
}
