            ...
            <div id="inputResult">
                    ...
                    <div class="col">
                        ...
                        <div class="descr">
                            ...
                            данных, предпринимаемые <span class="link mark owner-name-field" id="owner-name-value"
                                data-scroll-to="#owner-name-field">ООО "ЮграСпецСтрой"</span> (далее&nbsp;— Оператор).
                        </div>
                        <div class="ol">
                            <div class="li">
                            ...
                            <div class="li">
                                ...
                                которую Оператор может получить о&nbsp;посетителях веб-сайта <span
                                    ...
                                    data-scroll-to="#owner-site-url-field">https://ugra.spb.ru</span>.
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    <div class="col">
                        ...
                        <div class="ol">
                            <div class="li" id="if5nP">
                                <table class="purpose-table">
                                    <tbody>
                                        <tr>
                                            <th>Цель обработки</th>
                                            <td class="purpose-field"><span class="mark link">информирование
                                                    Пользователя
                                        ...
                                        <tr>
                                            ...
                                            <td class="legal-field">
                                                <ul>
                                                    <li><span class="mark link">уставные (учредительные) документы
                                                            Оператора</span></li>
                                                    <li><span class="mark link">договоры, заключаемые между оператором
                                            ...
                                            <td class="types-field">
                                                <ul>
                                                    <li><span class="mark link">Сбор, запись, систематизация,
                                                            накопление,
                                                            хранение, уничтожение и&nbsp;обезличивание персональных
                                                            данных</span></li>
                                                    <li><span class="mark link">Отправка информационных писем
                                                            на&nbsp;адрес
                                                            электронной почты</span></li>
                                                </ul>
                                            </td>
                                        </tr>
                                    </tbody>
                        ...
                        <div class="ol">
                            ...
                            <div class="li">
                                ...
                                Оператору уведомление на&nbsp;адрес электронной почты Оператора <span
                                    ...
                                    data-scroll-to="#owner-email-field">administration@ugra.spb.ru</span>
                        ...
                        <div class="ol">
                            ...
                            <div class="li">
                                ...
                                в&nbsp;сети Интернет по&nbsp;адресу <span id="owner-privacy-url-value"
                                    ...
                                    data-scroll-to="#owner-privacy-url-field">https://ugra.spb.ru/privacy</span>.
                            </div>
                        </div>
                    </div>
                </div>
